            ...
            <div class="row">
              ...
              <div class="col-md-8 post-cards">
                ...
                <div class="post-card">
                    <div class="row">
                     <div class="col-md-12">
                      <h3 class="m5-top">Developer Relations Ecosystem Program Manager, Sub-Saharan Africa</h3>
                      <div class="card__action p0-left">                        
                        <div class="card__author pull-left">
                          <img src="http://lorempixel.com/40/40/sports/" alt="user">
                          <div class="card__author-content">
                            By <a href="#">Bolaji Alade</a> | <time class="">18th March</time> | <span><i class="fa fa-comments"></i> 3 comments</span>
                          </div>                          
                        </div>
